"""
	...
	Date: 01/31/2024
	Description: Model of simple two-dimensional motion
    Depends:
...
class TwoD(DomainBehavior):
    ...
    def updatePhysicalState(self):
        ...
        self.state['physical_state'][comp.theta_dot] = (current_state[comp.theta] - self.state['physical_state'][comp.theta]) / self.getSigma()
